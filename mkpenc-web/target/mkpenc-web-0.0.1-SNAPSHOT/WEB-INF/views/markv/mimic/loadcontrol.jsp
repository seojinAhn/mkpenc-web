                        ...
                        <div class="chart_block small fx_full">
                            ...
                            <div class="chart_block_contents">
                                ...
                                <div class="switch_button">
                                    ...
                                    <label for="yes_load">Yes</label>
                                    <input type="radio" id="no_load" name="switch_load" value="" />
                                    <label for="no_load">No</label>
                                </div>
                            </div>
                        </div>
                        <div class="chart_block small fx_full">
                            ...
                            <div class="chart_block_contents">
                                <div class="switch_button">
                                    ...
                                    <label for="yes_rapid">Yes</label>
                                    <input type="radio" id="no_rapid" name="switch_rapid" value="" />
                                    <label for="no_rapid">No</label>
                                </div>
                            </div>
                        </div>
                        <div class="chart_block small fx_full">
                            ...
                            <div class="chart_block_contents">
                                <div class="switch_button">
                                    ...
                                    <label for="yes_watt">Yes</label>
                                    <input type="radio" id="no_watt" name="switch_watt" value="" />
                                    <label for="no_watt">No</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="chart_block small fx_full">
                            ...
                            <div class="chart_block_contents fx_row" style="padding-top:11px;">
                                <div class="com_block">
                                    <h6>TARGET</h6>
                                    <div class="switch_button">
                                        <input type="radio" id="target" name="switch_target_rate" value="" checked/>
                                ...
                                <div class="com_block">
                                    <h6>RATE</h6>
                                    <div class="switch_button">
                                        <input type="radio" id="rate" name="switch_target_rate" value="" checked/>
                                    ...
                                    <div class="switch_button">
                                        ...
                                        <label class="full" for="rate_raise">RAISE</label>
                                        <span class="ico_transper"></span>
