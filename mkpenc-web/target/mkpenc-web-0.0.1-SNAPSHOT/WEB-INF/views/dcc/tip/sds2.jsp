		...
		<div class="contents">
            ...
            <div class="form_wrap">
                ...
                <table class="form_table">
                    ...
                    <tbody>
                        <tr>
                            <th rowspan="4">PHT Core Differential Pressure</th>
                            <td colspan="2" class="tc">4</td>
                            <td rowspan="3" class="tc">즉시 TRIP</td>
                            <td rowspan="3" class="tc">
                                <div class="fx_form column center">
                                    <label>*1G, 3G 215KPa (1.287V)이하</label>
                                    <label>*2G, 4G 200KPa (1.260V)이하</label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tc">지연 TRIP(◇AVEC ＞ 70% FP)</td>
                            <td class="tc">950KPa (2.610V)이하</td>
                        </tr>                        
                        <tr>
                        ...
                        <tr>
                            <th rowspan="2">PHT High Pr'</th>
                            <td rowspan="2" colspan="2" class="tc">-</td>
                            <td class="tc">즉시 TRIP</td>
                            <td class="tc">11.62MPa (4.118V)</td>
                        </tr>
                        <tr>
                            <td class="tc bd_l_line">지연 TRIP(◇LINC ＞ 70% FP)</td>
                            <td class="tc">950KPa (2.610V)이하</td>
                        </tr>
                        <tr>
