                ...
                <table class="form_table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">0.28</label>
                                    <label class="full">MPA</label>
                                </div>                                
                            </td>
                            <td class="tc" colspan="4">
                                <div class="fx_form">
                                    <label class="double flex_end">0.45981</label>
                        ...
                        <tr>
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">1.1</label>
                        ...
                        <tr>
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">0.827</label>
                                    <label class="full">MPA</label>
                                </div>                                
                            </td>
                            <td class="tc" colspan="4">
                        ...
                        <tr>
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">3.9</label>
                                    <label class="full">MPA</label>
                                </div>                                
                            </td>
                            <td class="tc" colspan="4">
                        ...
                        <tr>
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">79</label>
                                    <label class="full">℃</label>
                                </div>                                
                            </td>
                            <td class="tc" colspan="4">
                        ...
                        <tr>
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">109.7</label>
                        ...
                        <tr>
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">2400</label>
                        ...
                        <tr>
                            ...
                            <td class="tc" rowspan="2">
                                <div class="fx_form">
                                    <label class="full flex_end">4.83</label>
                                    <label class="full">MPA</label>
                                </div>                                  
                            </td>
                            <th class="tc">SG #1</th>
                        ...
                        <tr>
                            ...
                            <td class="tc" rowspan="7">
                                <div class="fx_form_column">
                                    ...
                                    <div class="fx_form">
                                        <label class="full flex_center">TILT</label>
                                    </div>
                                    <div class="fx_form">
                                        <label class="full flex_end">0.2</label>
                                        <label class="full">FFP</label>
                                    </div>
                                </div>
                            </td>
