	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="page_title">
				<h3>SG PRESSURE CONTROL STATUS</h3>
                ...
                <table class="form_table">
                    ...
                    <tbody>
                        <tr class="row_color_a">
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">4.953</label>
                        ...
                        <tr>
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">YES</label>
                        ...
                        <tr>
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">HOLD</label>
                                    <label class="full"></label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="tc">
                                <div class="fx_form">
                                    <label class="full flex_end">0.0</label>
                                    <label class="full">DEGS/MIN</label>
                                </div>
                            </td>
                        </tr>
                    </tbody>
