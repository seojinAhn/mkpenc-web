...
public class MemberInfo {
	...
	private String loginHogi;
	private String email;
	private String grade;
	private String userIp;
	private String connTime;
	private String pwChTime;
	...
	/**
	 * @return the loginHogi
	 */
	public String getLoginHogi() {
		return loginHogi;
	}
	/**
	 * @param loginHogi the loginHogi to set
	 */
	public void setLoginHogi(String loginHogi) {
		this.loginHogi = loginHogi;
	}
	/**
	 * @return the email
	 */
	 ...
	 * @return the pwChTime
	 */
	public String getPwChTime() {
		return pwChTime;
	}
	/**
	 * @param pwChTime the pwChTime to set
	 */
	public void setPwChTime(String pwChTime) {
		this.pwChTime = pwChTime;
	}
	/**
	 * @return the useYn
	 */
