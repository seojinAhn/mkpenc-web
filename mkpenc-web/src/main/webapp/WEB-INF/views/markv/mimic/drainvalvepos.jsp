...
var tMarkTagSeq = [	
	...
	${MarkTagInfoList[30].iSeq},${MarkTagInfoList[31].iSeq}
];
...
var tMarkTagXy = [
	...
	'${MarkTagInfoList[30].XYGubun}','${MarkTagInfoList[31].XYGubun}'
];
...
$(function () {
	...
	$(document.body).delegate('#drainvalvepos_div label', 'dblclick', function() {		
...
function setTimer(hogiHeader,xyHeader,interval) {
	if( interval > 0 ) {
		setTimeout(function() {
			if( timerOn ) {
				var	comSubmit	=	new ComSubmit("drainvalveposFrm");
				comSubmit.setUrl("/markv/mimic/drainvalvepos");
...
function saveTag() {
	...
	comSubmit.addParam("rUrl", 'drainvalvepos');
...
<div class="wrap">
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="img_wrap drain_valve" id="drainvalvepos_div">
                <!-- range_slider -->
