...
$(function () {
	...
	$(document.body).delegate('#statorwatersys_div span', 'dblclick', function() {		
...
function saveTag() {
	...
	comSubmit.addParam("rUrl", 'statorwatersys');
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="page_title">
				<h3>STATOR WATER SYS</h3>
				<div class="bc"><span>MARK_V</span><span>Mimic</span><span>AUX</span><strong>STATOR WATER SYS</strong></div>
			</div>
			<!-- //page_title -->
			
			<form id="statorwatersysFrm" style="display:none"></form>
			<div class="img_wrap stator_water_sys" id="statorwatersys_div">
                <!-- range_slider -->
                ...
                <div class="chart_block small wide" style="top:180px;left:650px;">
                    <div class="chart_block_contents bd_none">
                        <div class="summary">
                            <p>
                                <span>PRESSURE</span>
                                <span id="9"><c:if test="${lblDataList[9].fValue eq null}">0</c:if>
                        ...
                        <div class="summary">
                            <p>
                                <span>FLOW</span>
                                <span id="10"><c:if test="${lblDataList[10].fValue eq null}">0</c:if>
                ...
                <div class="chart_block small single" style="top:270px;left:800px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                            <p>
                                <span id="11"><c:if test="${lblDataList[11].fValue eq null}">0</c:if>
