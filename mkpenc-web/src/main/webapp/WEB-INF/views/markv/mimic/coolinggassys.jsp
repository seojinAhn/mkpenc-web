...
$(function () {
	...
	$(document.body).delegate('#coolinggassys_div label', 'dblclick', function() {		
...
function saveTag() {
	...
	comSubmit.addParam("rUrl", 'coolinggassys');
...
<div class="wrap">
	...
	<div class="container">
		...
		<div class="contents">
			...
			<form id="coolinggassysFrm" style="display:none"></form>
            <div class="img_wrap cooling_gas_temperature" id="coolinggassys_div">
