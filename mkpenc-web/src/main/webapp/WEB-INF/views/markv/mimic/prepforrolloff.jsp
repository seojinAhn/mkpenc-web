...
var tMarkTagSeq = [	
	...
	${MarkTagInfoList[35].iSeq},${MarkTagInfoList[36].iSeq},${MarkTagInfoList[37].iSeq},${MarkTagInfoList[38].iSeq}
];
...
var tMarkTagXy = [
	...
	'${MarkTagInfoList[35].XYGubun}','${MarkTagInfoList[36].XYGubun}','${MarkTagInfoList[37].XYGubun}','${MarkTagInfoList[38].XYGubun}'
];
...
var tToolTipText = [
	...
	,"${MarkTagInfoList[36].toolTip}"	,"${MarkTagInfoList[37].toolTip}"	,"${MarkTagInfoList[38].toolTip}"
];
...
$(function () {
	...
	$(document.body).delegate('#prepforrolloff_div label', 'dblclick', function() {
...
function setTimer(hogiHeader,xyHeader,interval) {
	if( interval > 0 ) {
		setTimeout(function() {
			if( timerOn ) {
				var	comSubmit	=	new ComSubmit("prepforrolloffFrm");
				comSubmit.setUrl("/markv/mimic/prepforrolloff");
...
function saveTag() {
	...
	comSubmit.addParam("rUrl", 'prepforrolloff');	//return param 해당파일명 입력
...
<div class="wrap">
	...
	<div class="container">
		...
		<div class="contents">
			...
			<!-- //page_title -->
			<form id="prepforrolloffFrm" style="display:none"></form>
			<div class="img_wrap prep_for_roll_off" id="prepforrolloff_div">
                <!-- range_slider -->
