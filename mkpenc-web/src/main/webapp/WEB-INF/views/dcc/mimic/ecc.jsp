...
var tDccTagSeq = [
	...
	${DccTagInfoList[20].iSeq},${DccTagInfoList[21].iSeq},${DccTagInfoList[22].iSeq}
];
var tDccTagXy = [
	...
	'${DccTagInfoList[20].XYGubun}','${DccTagInfoList[21].XYGubun}','${DccTagInfoList[22].XYGubun}'
];
var tToolTipText = [
	...
	,"${DccTagInfoList[20].toolTip}"	,"${DccTagInfoList[21].toolTip}"	,"${DccTagInfoList[22].toolTip}"	
];
...
$(function () {
	$(document.body).delegate('#3', 'click', function() {
		...
		var comAjax = new ComAjax("eccFrm");
		comAjax.setUrl('/dcc/mimic/reloadEcc');
	...
	$(document.body).delegate('#Y', 'click', function() {
		...
		$(document.body).delegate('#eccdiv span', 'dblclick', function() {
...
function setTimer(interval) {
	if( interval > 0 ) {
		setTimeout(function run() {
			if( timerOn ) {
				//var	comSubmit	=	new ComSubmit("eccFrm");
				//comSubmit.setUrl("/dcc/mimic/ecc");
				//comSubmit.submit();
				var comAjax = new ComAjax("eccFrm");
				comAjax.setUrl('/dcc/mimic/reloadEcc');
				comAjax.addParam("sHogi",hogiHeader);
...
function saveTag() {
	...
	comSubmit.setUrl("/dcc/mimic/eccSaveTag");
	comSubmit.submit();
}
...
function toCSV() {
	var	comSubmit = new ComSubmit("eccFrm");
	comSubmit.setUrl("/dcc/mimic/eccExcelExport");
	comSubmit.submit();
}
</script>
</head>
...
<div class="wrap">
	...
	<div class="container">
		...
		<div class="contents">
			...
			<!-- //page_title -->
			<div class="img_wrap emergency_core_cooling" id="eccdiv">
                <!-- 마우스 우클릭 메뉴 -->
                ...
                <!-- //마우스 우클릭 메뉴 -->
			<form id="eccFrm" style="display:none">
