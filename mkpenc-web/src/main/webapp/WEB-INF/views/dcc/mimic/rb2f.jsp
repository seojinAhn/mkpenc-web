...
$(function () {
	$(document.body).delegate('#3', 'click', function() {
		...
		var comAjax = new ComAjax("rb2fFrm");
		comAjax.setUrl('/dcc/mimic/reloadRb2f');
	...
	$(document.body).delegate('#Y', 'click', function() {
		...
		$(document.body).delegate('#rb2fdiv span', 'dblclick', function() {
...
function setTimer(interval) {
	if( interval > 0 ) {
		setTimeout(function run() {
			if( timerOn ) {
				//var	comSubmit	=	new ComSubmit("rb2fFrm");
				//comSubmit.setUrl("/dcc/mimic/rb2f");
				//comSubmit.submit();
				var comAjax = new ComAjax("rb2fFrm");
				comAjax.setUrl('/dcc/mimic/reloadRb2f');
				comAjax.addParam("sHogi",hogiHeader);
...
function saveTag() {
	...
	comSubmit.setUrl("/dcc/mimic/rb2fSaveTag");
	comSubmit.submit();
}
...
function toCSV() {
	var	comSubmit = new ComSubmit("rb2fFrm");
	comSubmit.setUrl("/dcc/mimic/rb2fExcelExport");
	comSubmit.submit();
}
</script>
</head>
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="page_title">
				<h3>RB 2F</h3>
				<div class="bc"><span>DCC</span><span>Mimic</span><span>RADIATION</span><strong>RB 2F</strong></div>
			</div>
			<!-- //page_title -->
			<div class="img_wrap rb_2f" id="rb2fdiv">
                <!-- 마우스 우클릭 메뉴 -->
                ...
                <!-- //마우스 우클릭 메뉴 -->
			<form id="rb2fFrm" style="display:none">
			...
			<input type="hidden" id="sUGrpNo" name="sUGrpNo" value="${BaseSearch.sUGrpNo}">	
                ...
                <!-- //range_slider -->       
                <div class="toggle_block chart_block small wide" style="top:220px;left:620px;">
                    <h4>RT-10 (R-110)</h4>
