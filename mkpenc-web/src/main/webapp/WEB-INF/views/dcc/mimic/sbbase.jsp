...
var tDccTagSeq = [
	${DccTagInfoList[0].iSeq},${DccTagInfoList[1].iSeq},${DccTagInfoList[2].iSeq}
];
var tDccTagXy = [
	'${DccTagInfoList[0].XYGubun}','${DccTagInfoList[1].XYGubun}','${DccTagInfoList[2].XYGubun}'
];
var tToolTipText = [
	"${DccTagInfoList[0].toolTip}"	,"${DccTagInfoList[1].toolTip}"	,"${DccTagInfoList[2].toolTip}"	
];
...
$(function () {
	$(document.body).delegate('#3', 'click', function() {
		...
		var comAjax = new ComAjax("sbbaseFrm");
		comAjax.setUrl('/dcc/mimic/reloadSbbase');
	...
	$(document.body).delegate('#Y', 'click', function() {
		...
		$(document.body).delegate('#sbbasediv span', 'dblclick', function() {
...
function setTimer(interval) {
	if( interval > 0 ) {
		setTimeout(function run() {
			if( timerOn ) {
				//var	comSubmit	=	new ComSubmit("sbbaseFrm");
				//comSubmit.setUrl("/dcc/mimic/sbbase");
				//comSubmit.submit();
				var comAjax = new ComAjax("sbbaseFrm");
				comAjax.setUrl('/dcc/mimic/reloadSbbase');
				comAjax.addParam("sHogi",hogiHeader);
...
function saveTag() {
	...
	comSubmit.setUrl("/dcc/mimic/sbbaseSaveTag");
	comSubmit.submit();
}
...
function toCSV() {
	var	comSubmit = new ComSubmit("sbbaseFrm");
	comSubmit.setUrl("/dcc/mimic/sbbaseExcelExport");
	comSubmit.submit();
}
</script>
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="page_title">
				<h3>SB BASE</h3>
				<div class="bc"><span>DCC</span><span>RADIATION</span><strong>SB BASE</strong></div>
			</div>
			<!-- //page_title -->
			<div class="img_wrap sb_base" id="sbbasediv">
                <!-- 마우스 우클릭 메뉴 -->
                ...
                <!-- //마우스 우클릭 메뉴 -->
			<form id="sbbaseFrm" style="display:none">
			...
			<input type="hidden" id="sUGrpNo" name="sUGrpNo" value="${BaseSearch.sUGrpNo}">	
                ...
                <!-- //range_slider -->       
                <div class="toggle_block chart_block small wide" style="top:470px;left:190px;">
                    <h4>RT-29 (S-003)</h4>
                ...
                <div class="toggle_block chart_block small wide" style="top:390px;left:634px;">
                    <h4>RT-27 (S-006)</h4>
                    <div class="toggle_block_contents chart_block_contents">
                        <div class="summary">
                            <p>
                ...
                <div class="toggle_block chart_block small wide" style="top:510px;left:950px;">
                    <h4>RT-28 (S-015)</h4>
                    <div class="toggle_block_contents chart_block_contents">
                        <div class="summary">
                            <p>
