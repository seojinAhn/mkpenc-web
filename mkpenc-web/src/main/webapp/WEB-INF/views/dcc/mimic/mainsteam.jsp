...
$(function () {
	$(document.body).delegate('#3', 'click', function() {
		...
		var comAjax = new ComAjax("mainsteamFrm");
		comAjax.setUrl('/dcc/mimic/reloadMainsteam');
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="img_wrap main_steam" id="mainsteamdiv">
                ...
                <!-- //마우스 우클릭 메뉴 -->
			<form id="mainsteamFrm" style="display:none">
                    ...
                    <div class="chart_block_contents">
                        <div class="summary">
                            <p>
                                ...
                                <span class="per"><label id="lblUnit0">${DccTagInfoList[0].unit}</label></span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="chart_block_contents">
                        <div class="summary">
                            <p>
                                ...
                                <span class="per"><label id="lblUnit1">${DccTagInfoList[1].unit}</label></span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="chart_block_contents">
                        <div class="summary">
                            <p>
                                ...
                                <span class="per"><label id="lblUnit2">${DccTagInfoList[2].unit}</label></span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="chart_block_contents">
                        <div class="summary">
                            <p>
                                ...
                                <span class="per"><label id="lblUnit3">${DccTagInfoList[3].unit}</label></span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="chart_block_contents only_txt">
                        <div class="summary">
                            <p>
                                ...
                                <span class="per"><label id="lblUnit12">${DccTagInfoList[12].unit}</label></span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="chart_block_contents only_txt">
                        <div class="summary">
                            <p>
                                ...
                                <span class="per"><label id="lblUnit13">${DccTagInfoList[13].unit}</label></span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="chart_block_contents only_txt">
                        <div class="summary">
                            <p>
                                ...
                                <span class="per"><label id="lblUnit14">${DccTagInfoList[14].unit}</label></span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="chart_block_contents only_txt">
                        <div class="summary">
                            <p>
                                ...
                                <span class="per"><label id="lblUnit15">${DccTagInfoList[15].unit}</label></span>
                            </p>
                        </div>
                    </div>
                </div>
