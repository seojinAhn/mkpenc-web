...
$(function () {
	$(document.body).delegate('#3', 'click', function() {
		...
		var comAjax = new ComAjax("rb3fFrm");
		comAjax.setUrl('/dcc/mimic/reloadRb3f');
	...
	$(document.body).delegate('#Y', 'click', function() {
		...
		$(document.body).delegate('#rb3fdiv span', 'dblclick', function() {
...
function setTimer(interval) {
	if( interval > 0 ) {
		setTimeout(function run() {
			if( timerOn ) {
				//var	comSubmit	=	new ComSubmit("rb3fFrm");
				//comSubmit.setUrl("/dcc/mimic/rb3f");
				//comSubmit.submit();
				var comAjax = new ComAjax("rb3fFrm");
				comAjax.setUrl('/dcc/mimic/reloadRb3f');
				comAjax.addParam("sHogi",hogiHeader);
...
function saveTag() {
	...
	comSubmit.setUrl("/dcc/mimic/rb3fSaveTag");
	comSubmit.submit();
}
...
function toCSV() {
	var	comSubmit = new ComSubmit("rb3fFrm");
	comSubmit.setUrl("/dcc/mimic/rb3fExcelExport");
	comSubmit.submit();
}
</script>
</head>
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="page_title">
				<h3>RB 3F</h3>
				<div class="bc"><span>DCC</span><span>Mimic</span><span>RADIATION</span><strong>RB 3F</strong></div>
			</div>
			<!-- //page_title -->
			<div class="img_wrap rb_3f" id="rb3fdiv">
                <!-- 마우스 우클릭 메뉴 -->
                ...
                <!-- //마우스 우클릭 메뉴 -->
			<form id="rb3fFrm" style="display:none">
			...
			<input type="hidden" id="sUGrpNo" name="sUGrpNo" value="${BaseSearch.sUGrpNo}">	
                ...
                <!-- //range_slider -->       
                <div class="toggle_block chart_block small wide" style="top:160px;left:350px;">
                    <h4>RT-13 (R-306)</h4>
                ...
                <div class="toggle_block chart_block small wide" style="top:400px;left:280px;">
                    <h4>RT-22 (R-307)</h4>
                    <div class="toggle_block_contents chart_block_contents">
                        <div class="summary">
                            <p>
                ...
                <div class="toggle_block chart_block small wide" style="top:210px;left:610px;">
                    <h4>RT-21 (R-304)</h4>
                    <div class="toggle_block_contents chart_block_contents">
                        <div class="summary">
                            <p>
                ...
                <div class="toggle_block chart_block small wide" style="top:410px;left:610px;">
                    <h4>RT-20 (R-303)</h4>
                    <div class="toggle_block_contents chart_block_contents">
                        <div class="summary">
                            <p>
                ...
                <div class="toggle_block chart_block small wide" style="top:490px;left:590px;">
                    <h4>RT-12 (R-305)</h4>
                    <div class="toggle_block_contents chart_block_contents">
                        <div class="summary">
                            <p>
