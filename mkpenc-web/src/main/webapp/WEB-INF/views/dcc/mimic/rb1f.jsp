...
$(function () {
	$(document.body).delegate('#3', 'click', function() {
		...
		var comAjax = new ComAjax("rb1fFrm");
		comAjax.setUrl('/dcc/mimic/reloadRb1f');
...
function setData() {
	for( var i=0;i<lblDataListAjax.length;i++ ) {
		...
		$("#lbl1Limit"+i).text(DccTagInfoListAjax[i].dataLimit1);
		$("#lbl2Limit"+i).text(DccTagInfoListAjax[i].dataLimit2);
	}
}
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="img_wrap rb_1f" id="rb1fdiv">
                ...
                <!-- //마우스 우클릭 메뉴 -->
			<form id="rb1fFrm" style="display:none">
                        ...
                        <ul>
                            <li>
                                <p>
                                    ...
                                    <span id="lbl1Limit0">${DccTagInfoList[0].dataLimit1}</span>
                                    <span></span>
                                </p>
                            </li>
                            <li>
                                <p>
                                    ...
                                    <span id="lbl2Limit0">${DccTagInfoList[0].dataLimit2}</span>
                                    <span></span>
                                </p>
                            </li>
                        </ul>
                    ...
                    <div class="toggle_block_contents chart_block_contents">
                        ...
                        <ul>
                            <li>
                                <p>
                                    <span>Alert Alarm</span>
                                    <span id="lbl1Limit3">${DccTagInfoList[3].dataLimit1}</span>
                                    <span></span>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <span>High Alarm</span>
                                    <span id="lbl2Limit3">${DccTagInfoList[3].dataLimit2}</span>
                                    <span></span>
                                </p>
                            </li>
                        </ul>
                    ...
                    <div class="toggle_block_contents chart_block_contents">
                        ...
                        <ul>
                            <li>
                                <p>
                                    <span>Alert Alarm</span>
                                    <span id="lbl1Limit2">${DccTagInfoList[2].dataLimit1}</span>
                                    <span></span>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <span>High Alarm</span>
                                    <span id="lbl2Limit2">${DccTagInfoList[2].dataLimit2}</span>
                                    <span></span>
                                </p>
                            </li>
                        </ul>
                    ...
                    <div class="toggle_block_contents chart_block_contents">
                        ...
                        <ul>
                            <li>
                                <p>
                                    <span>Alert Alarm</span>
                                    <span id="lbl1Limit1">${DccTagInfoList[1].dataLimit1}</span>
                                    <span></span>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <span>High Alarm</span>
                                    <span id="lbl2Limit1">${DccTagInfoList[1].dataLimit2}</span>
                                    <span></span>
                                </p>
                            </li>
                        </ul>
                    ...
                    <div class="toggle_block_contents chart_block_contents">
                        ...
                        <ul>
                            <li>
                                <p>
                                    <span>Alert Alarm</span>
                                    <span id="lbl1Limit4">${DccTagInfoList[4].dataLimit1}</span>
                                    <span></span>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <span>High Alarm</span>
                                    <span id="lbl2Limit4">${DccTagInfoList[4].dataLimit2}</span>
                                    <span></span>
                                </p>
                            </li>
                        </ul>
                    ...
                    <div class="toggle_block_contents chart_block_contents">
                        ...
                        <ul>
                            <li>
                                <p>
                                    <span>Alert Alarm</span>
                                    <span id="lbl1Limit7">${DccTagInfoList[7].dataLimit1}</span>
                                    <span></span>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <span>High Alarm</span>
                                    <span id="lbl2Limit7">${DccTagInfoList[7].dataLimit2}</span>
                                    <span></span>
                                </p>
                            </li>
                        </ul>
                    ...
                    <div class="toggle_block_contents chart_block_contents">
                        ...
                        <ul>
                            <li>
                                <p>
                                    <span>Alert Alarm</span>
                                    <span id="lbl1Limit6">${DccTagInfoList[6].dataLimit1}</span>
                                    <span></span>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <span>High Alarm</span>
                                    <span id="lbl2Limit6">${DccTagInfoList[6].dataLimit2}</span>
                                    <span></span>
                                </p>
                            </li>
                        </ul>
                    ...
                    <div class="toggle_block_contents chart_block_contents">
                        ...
                        <ul>
                            <li>
                                <p>
                                    <span>Alert Alarm</span>
                                    <span id="lbl1Limit5">${DccTagInfoList[5].dataLimit1}</span>
                                    <span></span>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <span>High Alarm</span>
                                    <span id="lbl2Limit5">${DccTagInfoList[5].dataLimit2}</span>
                                    <span></span>
                                </p>
                            </li>
                        </ul>
