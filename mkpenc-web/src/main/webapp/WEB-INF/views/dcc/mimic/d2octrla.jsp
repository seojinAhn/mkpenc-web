...
$(function () {
	...
	$(document.body).delegate('#3', 'click', function() {
		...
		var comAjax = new ComAjax("d2octrlaFrm");
		comAjax.setUrl('/dcc/mimic/reloadD2octrla');
	...
	$(document.body).delegate('#Y', 'click', function() {
		...
		$(document.body).delegate('#d2octrladiv span', 'dblclick', function() {
...
function setTimer(interval) {
	if( interval > 0 ) {
		setTimeout(function run() {
			if( timerOn ) {
				//var	comSubmit	=	new ComSubmit("d2octrlaFrm");
				//comSubmit.setUrl("/dcc/mimic/d2octrla");
				//comSubmit.submit();
				var comAjax = new ComAjax("d2octrlaFrm");
				comAjax.setUrl('/dcc/mimic/reloadD2octrla');
				comAjax.addParam("sHogi",hogiHeader);
...
function saveTag() {
	...
	comSubmit.setUrl("/dcc/mimic/d2octrlaSaveTag");
	comSubmit.submit();
}
...
function toCSV() {
	var	comSubmit = new ComSubmit("d2octrlaFrm");
	comSubmit.setUrl("/dcc/mimic/d2octrlaExcelExport");
	comSubmit.submit();
}
</script>
</head>
...
<div class="wrap">
	...
	<div class="container">
		...
		<div class="contents">
			...
			<!-- //page_title -->
			<div class="img_wrap d2o_control_a_side" id="d2octrladiv">
                <!-- 마우스 우클릭 메뉴 -->
                ...
                <!-- //마우스 우클릭 메뉴 -->
			<form id="d2octrlaFrm" style="display:none"></form> 
                <!-- range_slider -->
                ...
                <div class="chart_block small single" style="top:156px;left:276px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                            ...
                            <p>
                             <span>FT22</span>                             
                             <span id="spansapn0"><label id="lblData0" title="${DccTagInfoList[0].toolTip}">${lblDataList[0].fValue}</label></span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="chart_block small single" style="top:116px;left:664px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                        	<p><label id="lblUnit4">${DccTagInfoList[4].unit}</label></p>    
                            <p>
                                <span>FT24</span>
                ...
                <div class="chart_block small single" style="top:116px;left:894px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                        	<p><label id="lblUnit7">${DccTagInfoList[7].unit}</label></p>    
                            <p>
                                <span>FT25</span>
                ...
                <div class="chart_block small single" style="top:116px;left:1094px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                        	<p><label id="lblUnit8">${DccTagInfoList[8].unit}</label></p>    
                            <p>
                                <span>FT23</span>
                ...
                <div class="chart_block small single" style="top:226px;left:616px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                        	<p><label id="lblUnit5">${DccTagInfoList[5].unit}</label></p>    
                            <p>
                                <span>PT4A</span>
                ...
                <div class="chart_block small single" style="top:200px;left:796px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                        	<p><label id="lblUnit6">${DccTagInfoList[6].unit}</label></p>    
                            <p>
                                <span>PT48</span>
                ...
                <div class="chart_block small single" style="top:310px;left:690px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                        	<p><label id="lblUnit9">${DccTagInfoList[9].unit}</label></p>    
                            <p>
                                <span>PT16</span>
