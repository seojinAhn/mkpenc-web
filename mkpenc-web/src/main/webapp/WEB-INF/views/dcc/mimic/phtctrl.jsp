...
$(function () {
	$(document.body).delegate('#3', 'click', function() {
		...
		var comAjax = new ComAjax("phtctrlFrm");
		comAjax.setUrl('/dcc/mimic/reloadPhtctrl');
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="img_wrap pht_control" id="phtctrldiv">
                ...
                <!-- //마우스 우클릭 메뉴 -->
			<form id="phtctrlFrm" style="display:none">
			...
			<input type="hidden" id="sUGrpNo" name="sUGrpNo" value="${BaseSearch.sUGrpNo}">
                ...
                <div class="chart_block small mini" style="top:434px;left:310px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                            <p>
                                <span>P</span>
                                <c:if test="${lblDataList[23].fValue ne null}">
                                 ...
                                 <c:if test="${lblDataList[23].fValue eq null}">
                                <span id="span23"><label id="lblData23" title="${DccTagInfoList[23].toolTip}">0</label></span>
                                <span><label id="lblUnit23">AAAAA</label></span>
                                </c:if>
                ...
                <div class="chart_block small mini" style="top:520px;left:310px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                            <p>
                                <span>P</span>
                                <c:if test="${lblDataList[24].fValue ne null}">
                                 ...
                                 <c:if test="${lblDataList[24].fValue eq null}">
                                <span id="span24"><label id="lblData24" title="${DccTagInfoList[24].toolTip}">0</label></span>
                                <span><label id="lblUnit24">AAAAA</label></span>
                                </c:if>
                            </p>
                        </div>
                    </div>
                ...
                <div class="chart_block small mini" style="top:512px;left:510px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                            <p>
                                <span>P</span>
                                <c:if test="${lblDataList[6].fValue ne null}">
                                ...
                                <c:if test="${lblDataList[6].fValue eq null}">
                                <span id="span6"><label id="lblData6" title="${DccTagInfoList[6].toolTip}">-0.014</label></span>
                                <span><label id="lblUnit6">%</label></span>
                                </c:if>
                ...
                <div class="chart_block small mini" style="top:446px;right:170px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                            <p>
                                <span>P</span>
                                <c:if test="${lblDataList[25].fValue ne null}">
                                ...
                                <c:if test="${lblDataList[25].fValue eq null}">
                                <span id="span25"><label id="lblData25" title="${DccTagInfoList[25].toolTip}">0</label></span>
                                <span><label id="lblUnit25">AAAAA</label></span>
                                </c:if>
                            </p>
                        </div>
                    </div>
                ...
                <div class="chart_block small mini" style="top:544px;right:170px;">
                    <div class="chart_block_contents only_box">
                        <div class="summary">
                            <p>
                                <span>P</span>
                                <c:if test="${lblDataList[26].fValue ne null}">
                                ...
                                <c:if test="${lblDataList[26].fValue eq null}">
                                <span id="span26"><label id="lblData26" title="${DccTagInfoList[26].toolTip}">0</label></span>
                                <span><label id="lblUnit26">AAAAA</label></span>
                                </c:if>
                            </p>
                        </div>
                    </div>
                ...
                <div class="toggle_block small" style="top:200px;left:386px;">
                    ...
                    <div class="toggle_block_contents">
                        <div class="summary">
                            <p><label id="lblUnit1">${DccTagInfoList[1].unit}</label></p>
                            <p>
                                <span>P</span>
                        ...
                        <ul>
                            <li>
                                <p><label id="lblUnit0">${DccTagInfoList[0].unit}</label></p>
                                <p>
                                    <span>L</span>
                            ...
                            <li>
                                <p><label id="lblUnit2">${DccTagInfoList[2].unit}</label></p>
                                <p>
                                    <span>LIQ. T</span>
                            ...
                            <li>
                                <p><label id="lblUnit3">${DccTagInfoList[3].unit}</label></p>
                                <p>
                                    <span>STM. T</span>
                ...
                <div class="toggle_block small" style="top:200px;left:950px;">
                    ...
                    <div class="toggle_block_contents">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><label id="lblUnit14">${DccTagInfoList[14].unit}</label></p>
                                <p>
                                    <span>LIQ T</span>
                            ...
                            <li>
                                <p><label id="lblUnit15">${DccTagInfoList[15].unit}</label>>/p>
                                <p>
                                    <span>STM T</span>
                            ...
                            <li>
                                <p><label id="lblUnit16">${DccTagInfoList[16].unit}</label></p>
                                <p>
                                    <span>BLUK T</span>
                            ...
                            <li>
                                <p><label id="lblUnit17">${DccTagInfoList[17].unit}</label></p>
                                <p>
                                    <span>VAR HTR</span>
