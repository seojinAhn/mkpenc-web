...
<script type="text/javascript">
	...
	function toCSV() {
		...
		comSubmit.setUrl("/dcc/status/mtcExcelExport");
		comSubmit.submit();
	}
	...
	function setTimer(interval) {
		if( interval > 0 ) {
			setTimeout(function run() {
				if( timerOn ) {
					//var	comSubmit	=	new ComSubmit("reloadFrm");
					//comSubmit.setUrl("/dcc/status/mtc");
					//comSubmit.submit();
					var comAjax = new ComAjax("reloadFrm");
					comAjax.setUrl('/dcc/status/reloadMtc');
	...
	function saveTag() {
		...
		comSubmit.setUrl("/dcc/status/mtcSaveTag");
		comSubmit.submit();
	}
	...
	function tagSearchEvent(){
		...
		comAjax.setUrl("/dcc/status/mtcTagSearch");
	...
	function tagFind(type) {
		...
		comAjax.setUrl("/dcc/status/mtcTagFind");
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="page_title">
				<h3 id="testclick" name="testclick">MTC</h3>
            ...
            <div class="fx_layout"> 
                ...
                <div class="fx_block">        
                    ...
                    <div class="form_wrap">
                        ...
                        <table id="dccStatusMTC1" class="form_table">
                            <colgroup>
                                <col />
                                <col />
                            </colgroup>
                            <tr>
                                ...
                                <td class="tc">
                                    <div class="fx_form">
                                    	...
                                    	<label id="lblUnit0" class="full">°C</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="tc">
                                    <div class="fx_form">
                                    	...
                                    	<label id="lblUnit2" >${DccTagInfoList[2].unit}</label>
                            ...
                            <tr>
                                ...
                                <td class="tc">
                                    <div class="fx_form">
                                    	...
                                    	<label id="lblUnit3">${DccTagInfoList[3].unit}</label>
                            ...
                            <tr>
                                ...
                                <td class="tc">
                                    <div class="fx_form">
                                    	...
                                    	<label id="lblUnit4" >${DccTagInfoList[4].unit}</label>
                            ...
                            <tr>
                                ...
                                <td class="tc">
                                    <div class="fx_form">
                                        <label id="const0" class="full flex_end">7550</label>
                                        <label id="const6" class="full">MM</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="fx_block">        
                    ...
                    <div class="form_wrap">
                        ...
                        <!-- form_table -->
                        <table id="dccStatusMTC2" class="form_table">
                            <colgroup>
                                <col />
                                <col />
                            </colgroup>
                            ...
                            <tr>
                                ...
                                <td class="tc">
                                    <div class="fx_form">
                                        <label id="const2" class="full flex_end">&nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;85</label>
                                        <label id="const1" class="full">DEG C</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="tc">
                                    <div class="fx_form">
                                    	...
                                    	<label id="lblUnit9">${DccTagInfoList[9].unit}</label>
