...
<script type="text/javascript">
	...
	function setTimer(num){
		if( num == 0 ) {
			...
			comAjax.addParam('uMenuNo','31');
			comAjax.addParam('fixed','F');
			comAjax.addParam('sGrpID','bar');
	...
	function toCSV() {
		...
		comSubmit.addParam("sGrpID", 'bar');
		comSubmit.addParam("sMenuNo", '31');
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="page_title">
				<h3>BARCHART</h3>
				<div class="bc"><span>DCC</span><span>Trend</span><strong>BARCHART FIXED</strong></div>
			</div>
			<!-- //page_title -->
			<!-- fx_srch_wrap -->
