	...
	$("#lblDate").css('color','${ForeColor}');
  	...
  	$("#cboUGrpName").change(function(){
  		...
  		if($("#cboUGrpName option:selected").val() != ""){
			...
			comAjax.setUrl('/dcc/trend/reloadLogfixedlist');
...
function openModal(str) {
	...
	if( str == 'modal_1' ) {
		...
		var selGrpName = tmpGrpName.substring(tmpGrpName.indexOf('&nbsp;')+7,tmpGrpName.length);
...
function toCSV() {
	function prePart() {
		return new Promise(function(resolve,reject) {
			...
			comSubmit.setUrl("/dcc/trend/lfExcelExport");
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div class="list_wrap">
				...
				<input type = "hidden" id="sMenuNo" name="sMenuNo" value = "23">
	...
	<div class="pop_contents">
        ...
        <div class="list_wrap">
            ...
            <table>
            	...
            	<tr>
            		<td style="display:none">
            			<input type="hidden" id="ajaxHogi" value="">
            			<input type="hidden" id="ajaxXYGubun" value="">
            			<input type="hidden" id="ajaxLoopName" value="">
            			<input type="hidden" id="ajaxIOType" value="">
            			<input type="hidden" id="ajaxAddress" value="">
            			<input type="hidden" id="ajaxIOBit" value="">
	                    <input type="hidden" id="ajaxMin" value="">
	                    <input type="hidden" id="ajaxMax" value="">
	                    <input type="hidden" id="ajaxSaveCore" value="">
	                    <input type="hidden" id="ajaxFastIoChk" value="">
	                    <input type="hidden" id="ajaxISeq" value="">
            		</td>
            	</tr>
            	</tbody>
            </table>
            ...
            <table>
            	...
            	<tr>
            		<td style="display:none">
						<input type="hidden" id="hogiMod" value="">
						<input type="hidden" id="xyGubunMod" value="">
						<input type="hidden" id="DescrMod" value="">
						<input type="hidden" id="ioTypeMod" value="">
						<input type="hidden" id="addressMod" value="">
						<input type="hidden" id="ioBitMod" value="">
						<input type="hidden" id="minValMod" value="">
						<input type="hidden" id="maxValMod" value="">
						<input type="hidden" id="saveCoreMod" value="">
						<input type="hidden" id="gubunMod" value="">
						<input type="hidden" id="iSeqMod" value="">
					</td>
            	</tr>
            	</tbody>
            </table>
