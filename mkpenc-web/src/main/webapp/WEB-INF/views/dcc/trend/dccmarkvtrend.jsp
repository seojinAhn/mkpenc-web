...
<script type="text/javascript">
	...
	function setTimer(num){
		if( num == 0 ) {
			...
			comAjax.addParam('uMenuNo','91');
			comAjax.addParam('fixed','B');
		...
		chartPart().then(function() {
			...
			if( !isInit ) {
				...
				for( var ac=0;ac<xAxis.length;ac++ ) {
					if( activeCharts[ac] != ac ) activeCharts.push(ac);
				}
			}
	...
	function toCSV() {
		...
		var comSubmit = new ComSubmit("selGrpFrm");
		comSubmit.setUrl("/dcc/trend/dmExcelExport");
		...
		comSubmit.addParam('sMenuNo','91');
		comSubmit.addParam('fixed','B');
		comSubmit.submit();
	}
	...
	<div class="container">
		...
		<div id="captureArea" class="contents">
			...
			<div class="page_title" style="max-height:45px;margin-bottom:10px">
				...
				<div id="trendPath" class="bc"><span>DCC</span><span>Trend</span><strong>TREND DCC & Mark-V</strong></div>
			</div>
			<!-- //page_title -->
			<!-- fx_srch_wrap -->
