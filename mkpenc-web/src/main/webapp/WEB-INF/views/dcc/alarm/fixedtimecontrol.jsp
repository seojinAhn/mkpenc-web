					...
					<div class="fx_srch_row">
						...
						<div class="fx_srch_item">
                            ...
                            <div class="fx_form_multi">
                                ...
                                <input type="text" value="13:17:42" class="fx_none" style="width:60px">
                            </div>
						</div>
            ...
            <div class="list_wrap">
				...
				<div class="list_head">
					...
					<div class="button">
						...
						<a class="btn_list" href="#none">화면저장</a>
					</div>
					<!-- button -->
				</div>
				<!-- //list_head -->
                ...
                <div class="fx_block">
                    ...
                    <div class="list_wrap">
                        ...
                        <table class="list_table">
                            ...
                            <tbody>
                                <tr>
                                    <td class="tc" rowspan="6">채널 "G"</td>
                                    <td class="tc">CI 0000</td>
                                    <td class="tc"></td>
                                    <td class="tc"></td>
                                    <td class="tc"></td>
                                </tr>
